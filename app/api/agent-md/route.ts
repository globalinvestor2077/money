...
export async function GET() {
  ...
  const body = [
    ...
    `- **内容作者**：${expertCount || 0} 位`,
    '',
    '## API 接口',
    '',
    '### 问答 API',
    '',
    `- **问答列表**：[\`GET ${siteUrl}/money/qa/home\`](${siteUrl}/money/qa/home) — 首页数据（统计、热门问题、话题、作者）`,
    ...
    `- **作者管理**：[\`${siteUrl}/admin/experts\`](${siteUrl}/admin/experts)`,
    '',
    '## 分类目录',
    '',
